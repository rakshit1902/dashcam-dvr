    ...
    <div style={{ minHeight: "100vh", backgroundColor: "#111" }}>
      ...
      <div style={{ backgroundColor: "#1a1a1a", borderBottom: "1px solid #2a2a2a", padding: "16px 32px", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
        ...
        <div style={{ display: "flex", backgroundColor: "#222", border: "1px solid #333", borderRadius: "6px", overflow: "hidden" }}>
          <button
            ...
            style={{ padding: "6px 20px", border: "none", cursor: "pointer", fontSize: "0.78rem", fontFamily: "Inter, sans-serif", backgroundColor: viewMode === "single" ? "#fff" : "transparent", color: viewMode === "single" ? "#111" : "#666", fontWeight: viewMode === "single" ? "600" : "400", transition: "all 0.15s" }}
          >
            Single
          </button>
          <button
            onClick={() => setViewMode("dual")}
            style={{ padding: "6px 20px", border: "none", cursor: "pointer", fontSize: "0.78rem", fontFamily: "Inter, sans-serif", backgroundColor: viewMode === "dual" ? "#fff" : "transparent", color: viewMode === "dual" ? "#111" : "#666", fontWeight: viewMode === "dual" ? "600" : "400", transition: "all 0.15s" }}
          >
            Dual
          </button>
        </div>
      ...
      <div style={{ maxWidth: "1080px", margin: "0 auto", padding: "32px 24px" }}>
        ...
        <div style={{ display: "flex", gap: "8px", marginBottom: "20px", flexWrap: "wrap" }}>
          {[
            { label: "Clip", value: currentClip.label },
            { label: "Start", value: currentClip.startTime },
            { label: "End", value: currentClip.endTime },
          ].map(({ label, value }) => (
        ...
        <Timeline clips={clips} currentClip={currentClip} onClipSelect={handleClipSelect} />
